...
<p align="center">
<a href="./thought_projection_creation.md"><img alt="Primary Scroll" src="https://img.shields.io/static/v1?label=Scroll&message=Open+Main+Doc&color=00b894"></a>
<a href="#ingress-ladder"><img alt="Ingress Ladder" src="https://img.shields.io/static/v1?label=Focus&message=Multimodal+to+Neural&color=6c5ce7"></a>
...
```mermaid
flowchart LR
    Voice["Voice / text"] --> Ingress["Intent ingress ladder"]
    Sketch["Sketch / image"] --> Ingress
    Gesture["Gesture / embodied input"] --> Ingress
    Veil["Thought Veil"] --> Ingress
    Ingress --> Intent["Structured intent"]
    Intent --> SOP["SOP weave"]
    SOP --> Studio["VR Studio preview / commit"]
```
