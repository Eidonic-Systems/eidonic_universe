...
<p align="center">
<a href="./eidonic_vr_studio.md"><img alt="Primary Scroll" src="https://img.shields.io/static/v1?label=Scroll&message=Open+Main+Doc&color=00b894"></a>
<a href="#realm-and-persistence-model"><img alt="Realm and Persistence" src="https://img.shields.io/static/v1?label=Focus&message=Always+On&color=2ecc71"></a>
...
```mermaid
flowchart LR
    Intent["Structured intent"] --> SOP["SOP weave"]
    SOP --> Preview["Preview scenes"]
    Preview --> Realm["Persistent realm state"]
    Realm --> Review["Human + EKRP review"]
    Review --> Ravien["Ravien witness"]
    Ravien --> Commit["Governed commit"]
```
