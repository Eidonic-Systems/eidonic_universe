...
<p align="center">
<a href="#1-executive-vision"><img alt="Status" src="https://img.shields.io/static/v1?label=Status&message=Pitch-Ready%20Pre-Spec&color=00b894"></a>
...
<a href="#6-ai--automation-roadmap"><img alt="Automation" src="https://img.shields.io/static/v1?label=Autonomy&message=Constellation-Governed&color=8e44ad"></a>
...
```mermaid
flowchart LR
  RFUC[Remote Fission Utility Core] --> UMG[Utility Microgrid]
  UMG --> SC[Sterile Core]
  UMG --> FF[FrameForge]
  UMG --> AS[Assemble]
  SC --> BF[BioFoundry]
  BF --> GR[Grow]
  GR --> CC[Cure Coordinator + Cure Cells]
  CC --> RP[Repair]
  RP --> AS
  FF --> AS
  AS --> JH[Join Habitat]
  JH --> BAY[Structure Production Bay]
  JH --> BUNKER[Shielded Utility Bunker]
```
